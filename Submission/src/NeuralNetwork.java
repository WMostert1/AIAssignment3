...
public class NeuralNetwork{
     ...
     * @param bias The type of activation function to use for biases (this jst returns -1)
     * @param activationFunction  The type of activation function to use for nodes in the network
     */
    ...
    /**
     *  This method adjusts the weights of the neural network
     * @param trainingExamples A list of examples to train on
     * @param generalizationExamples A list of examples to see how well the NN generalises
     * @return A string representation of the change in At and Ag
     */
